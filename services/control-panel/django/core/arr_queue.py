"""Arr queue operations — fetch, filter, snapshot, dedup, monitoring.

Extracted from core/arr_client.py. Imports ARR_APPS, QUEUE_ARR_APPS,
RADARR_APPS from core/arr_config for app configuration.
"""
import re
...
from core.arr_config import ARR_APPS, QUEUE_ARR_APPS, RADARR_APPS
